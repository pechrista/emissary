...
public class DropOffUtil {
    ...
    /**
     * Get the file type from the IBaseDataObject passed in
     *
     * @param bdo IBaseDataObject
     * @return the file type (also added to the IBaseDataObject if not present)
     */
    public static String getFileType(final IBaseDataObject bdo) {
        return getFileType(bdo, null);
    }
     ...
     */
    public static String getFileType(final IBaseDataObject bdo, final String formsArg) {
        String forms = formsArg;
        if (forms == null) {
    ...
    /**
     * Get the complete file type from the IBaseDataObject or the form string passed in
     *
     * @param bdo IBaseDataObject
     * @param formsArg space separated string of current forms
     * @return the complete file type
     */
    public static String getCompleteFileType(final IBaseDataObject bdo, final String formsArg) {
        String forms = formsArg;
        if (forms == null) {
            forms = bdo.getStringParameter(FileTypeCheckParameter.POPPED_FORMS.getFieldName());
            if (forms == null) {
        ...
        if (!bdo.hasParameter(FileTypeCheckParameter.FILETYPE.getFieldName()) &&
                !bdo.hasParameter(FileTypeCheckParameter.FINAL_ID.getFieldName()) &&
                forms.contains(" ")) {
            return forms;
        } else {
            return null;
    ...
    /**
     * Parameters that are used to determine filetype in {@link #getFileType(IBaseDataObject, String)}
     */
